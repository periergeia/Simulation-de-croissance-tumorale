"""module contenant des fonctions et classes utiles."""
...
try:
    ...
    from module.constant import COLOR, FONT_HEIGHT


# initialisation de pygame
pygame.init()
 
# préréglage du module mixer en ce qui concerne les effets sonores
...
def loop_starter_pack(window, event):
    ...
    if event.type == pygame.VIDEORESIZE:
        ...
        print(f"current window's size :   {window.get_size()}")  # ##
    return window
